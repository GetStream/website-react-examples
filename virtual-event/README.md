...
The main purpose of this demo is to showcase how Stream's React SDK can be used for building Virtual Event kind of applications.

# Development process

1. Clone this repository
2. `cd virtual-event && yarn install`
...
6. Once the deployment process is finished, you can see your changes live on the [main website](https://getstream.io/chat/demos/livestream//).
